<div class="widget" id="ajax" >
    ...
    <div class="newOrder">
        <div class="userRow">
            ...
            <ul class="leftList">
                <li><a href="#" title=""><strong>Lưu Quốc Phong</strong></a></li>
                <li>Email: mrphng678@gmail.com</li>
            </ul>
            <ul class="rightList">
        ...
        <div class="orderRow">
            ...
            <ul class="rightList">
                ...
                <li><strong class="green">098.3030.495</strong></li>
                <li><strong class="orange">Lorem Ipsum is simply a dummy dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.

                        It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</strong></li>
            </ul>
            <div class="clear"></div>
        </div>
