...
<div class="errorWrapper">
    ...
    <span class="errorDesc">Bạn không đủ quền để truy cập trang này!</span>
    <a href="{{route('admin.index.index')}}" title="" class="button dredB"><span>Quay lại trang chủ</span></a>
</div>    
